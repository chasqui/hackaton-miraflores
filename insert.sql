...
COPY OBRA(TIPO_OBRA_ID, NOMBRE, DESCRIPCION, GEOM, VIA_ID, FECHA_INICIO, FECHA_FIN) FROM '/home/jose/Documents/GIS/hack/hackaton-miraflores/output/o9_obra.csv' WITH CSV HEADER DELIMITER '|';
