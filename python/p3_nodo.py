...
def dict_via() :
	dict = {}
	with open("../output/o2_via.csv", "r") as csvfile:
...
file_nodo	= open("../output/o3_nodo.csv", "wb")
file_nodo.write("idnodo|longitud|latitud|geom\n")

file_arista	= open("../output/o4_arista.csv", "wb")
file_arista.write("idarista|idnodoorigen|idnododestino|idvia|distancia|geom\n")
